...
input double   risk_reward_ratio = 1.5; // Ratio Riesgo/Beneficio para el Take Profit
...
void OnTick()
{
    ...
    {
        double stop_loss = last_low;
        double risk = current_price - stop_loss;
        double take_profit = current_price + (risk * risk_reward_ratio);
    ...
    {
        double stop_loss = last_high;
        double risk = stop_loss - current_price_bid;
        double take_profit = current_price_bid - (risk * risk_reward_ratio);
